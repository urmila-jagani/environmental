        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{url("frontend/img/logo/loder.png")}}" alt="">
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">
                                                ...
                                                <li><a href="{{url('/about')}}">Guidelines</a></li>
                                                ...
                                                <li><a href="{{url('/blog')}}">Palnting</a>
                                                    <ul class="submenu">
                                                        <li><a href="{{url('/blog')}}">Spacies</a></li>
                                                        <li><a href="{{url('/blog_details')}}">Seed Bank</a></li>
                                                        <li><a href="{{url('/element')}}">Gardern Panting</a></li>
                                                    </ul>
                                                </li>
